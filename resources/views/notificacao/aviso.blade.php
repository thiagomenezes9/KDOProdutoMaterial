                                            ...
                                            <td style="border-collapse: collapse;">
                                                <h2 style="font-weight: normal; margin: 0px; padding:
                                                   ...
                                                   text-align: center; width: 100%; color: #666;">
                                                                ...
                                                                Hey você! O produto que você esperou Chegou !!!
                                                   ...
                                                   break-word;">
                                                    ...
                                                    <div style="text-align:
                                                      center;">
                                                                ...
                                                                O produto <strong>{{$produto->descricao}}</strong><br>
                                                                Chegou no <strong>{{$preco->supermercado->nome}}</strong><br>
                                                                Você pagara <strong>R$ {{$preco->valor}} </strong>
