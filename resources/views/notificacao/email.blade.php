                                            ...
                                            <td style="border-collapse: collapse;">
                                                <h2 style="font-weight: normal; margin: 0px; padding:
                                                   ...
                                                   text-align: center; width: 100%; color: #666;">
                                                                ...
                                                                Hey você! Nova Oferta do produto de seu interesse
                                                   ...
                                                   break-word;">
                                                    ...
                                                    <div style="text-align:
                                                      center;">
                                                                ...
                                                                Uma nova oferta foi criada para <strong>{{$produto->descricao}}</strong><br>
                                                                Oferta realizada pelo <strong>{{$oferta->supermercado->nome}}</strong><br>
                                                                Você pagara somente <strong>R$ {{$oferta->valor}} </strong>
                                                                até {{\Carbon\Carbon::parse($oferta->dt_fim)->format('d/m/Y')}}.<br>
                                          ...
                                          bold; text-align: center;">
                                            ...
                                            <tr style="display:
                                                ...
                                                <td align="center" style="border-collapse: collapse; display:
                                                   ...
                                                   100%;" href="{{url(config('app.url').('/busca/'.$produto->id))}}">Ir para o Produto</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
